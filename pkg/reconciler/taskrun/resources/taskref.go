...
func (l *LocalTaskRefResolver) GetTask(name string) (v1beta1.TaskInterface, error) {
	if l.Kind == v1beta1.ClusterTaskKind {
		task, err := l.Tektonclient.TektonV1beta1().ClusterTasks().Get(context.TODO(), name, metav1.GetOptions{})
		if err != nil {
			return nil, err
		}
		return task, nil
	...
	return l.Tektonclient.TektonV1beta1().Tasks(l.Namespace).Get(context.TODO(), name, metav1.GetOptions{})
}
